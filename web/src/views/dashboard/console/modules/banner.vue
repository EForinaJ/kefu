<template>
  ...
  >
    <div class="flex mt-6">
      ...
      <div class="mr-8">
        <p class="text-3xl">
          <ArtCountTo class="number box-title" :target="salesComparison!" :duration="1500" suffix="%" />
          <ArtSvgIcon v-if="salesComparison! > 0" icon="ri:arrow-right-up-line" class="text-xl text-success relative -top-2" />
            <ArtSvgIcon v-if="salesComparison! < 0" icon="ri:arrow-right-down-line" class="text-xl text-error relative -top-2" />
        </p>
